!function(t, e) {
        ...
        function o(r) {
            ...
            return o && t.each(o.split(" "), function(r) {
                ...
                t.each(this.split(","), function(r, i) {
                    if ("title" == i)
                        a.append("<span class='fc-header-title'><h2>&nbsp;</h2></span>"), o && o.addClass(d + "-corner-right"), o = null;
                    else {
                        var s;
    ...
    function o(n, r) {
        ...
        function s(e, r) {
            ...
            var l = e.events;
            if (l)
                t.isFunction(l) ? (m(), l(d(T), d(E), function(t) {
                    r(t), y()
                })) : t.isArray(l) ? r(l) : r();
            else {
                var c = e.url;
                if (c) {
                    ...
                    p && (g[p] = Math.round(+T / 1e3)), b && (g[b] = Math.round(+E / 1e3)), m(), t.ajax(t.extend({}, ye, e, {data: g, success: function(e) {
                            e = e || [];
        ...
        function f(t) {
            ...
            for (e = 0; r > e; e++)
                n = W[e], n._id == t._id && n != t && (n.start = new Date(+n.start + o), n.end = t.end ? new Date(n.end ? +n.end + i : +a(n) + i) : null, n.title = t.title, n.url = t.url, n.allDay = t.allDay, n.className = t.className, n.editable = t.editable, n.color = t.color, n.backgroundColor = t.backgroundColor, n.borderColor = t.borderColor, n.textColor = t.textColor, b(n));
            b(t), k(W)
        }
        function v(t, e) {
        ...
        function D(t) {
            ...
            for (var e = pe.sourceNormalizers, n = 0; n < e.length; n++)
                e[n](t)
        }
        function w(t, e) {
            return t && e && C(t) == C(e)
        ...
        for (var T, E, S = M.trigger, x = M.getView, k = M.reportEvents, H = {events: []}, F = [H], R = 0, N = 0, z = 0, W = [], A = 0; A < r.length; A++)
            c(r[A])
    }
    function i(t, e, n) {
    ...
    function Z(e, n, r) {
        ...
        function u() {
            ...
            for (r += "<thead><tr>", pe && (r += "<th class='fc-week-number " + n + "'>" + q(me) + "</th>"), t = 0; ne > t; t++)
                e = Ee(0, t), r += "<th class='fc-day-header fc-" + De[e.getDay()] + " " + n + "'>" + q(ke(e, ge)) + "</th>";
            return r += "</tr></thead>"
        }
        function v() {
            var t, e, n, r = he + "-widget-content", a = "";
            for (a += "<tbody>", t = 0; ee > t; t++) {
                for (a += "<tr class='fc-week'>", pe && (n = Ee(t, 0), a += "<td class='fc-week-number " + r + "'><div>" + q(ke(n, ye)) + "</div></td>"), e = 0; ne > e; e++)
                    n = Ee(t, e), a += h(n);
                a += "</tr>"
            }
            return a += "</tbody>"
    ...
    function K(n, r, a) {
        ...
        function g() {
            ...
            for (a += "<thead><tr>", Je?(e = sn(t, Ue), Pe?e += Ve:e = Ve + e, a += "<th class='fc-agenda-axis fc-week-number " + r + "'>" + q(e) + "</th>"):a += "<th class='fc-agenda-axis " + r + "'>&nbsp;</th>", n = 0; Ae > n; n++)
                t = rn(0, n), a += "<th class='fc-" + De[t.getDay()] + " fc-col" + n + " " + r + "'>" + q(sn(t, Xe)) + "</th>";
            return a += "<th class='fc-agenda-gutter " + r + "'>&nbsp;</th></tr></thead>"
        }
        function p() {
            var t, e, n, r, a, o = Be + "-widget-header", i = Be + "-widget-content", s = f(new Date), l = "";
            for (l += "<tbody><tr><th class='fc-agenda-axis " + o + "'>&nbsp;</th>", n = "", e = 0; Ae > e; e++)
                t = rn(0, e), a = ["fc-col" + e, "fc-" + De[t.getDay()], i], +t == +s ? a.push(Be + "-state-highlight", "fc-today") : a.push(s > t ? "fc-past" : "fc-future"), r = "<td class='" + a.join(" ") + "'><div><div class='fc-day-content'><div style='position:relative'>&nbsp;</div></div></div></td>", n += r;
                ...
                if (a >= 0 && Ae > a) {
                    ...
                    if (s > i) {
                        if (o.top = i, o.height = s - i, o.left += 2, o.width -= 5, t.isFunction(r)) {
                            ...
                            o.isStart = !0, o.isEnd = !0, Ee = t(nn({title: "", start: e, end: n, className: ["fc-select-helper"], editable: !1}, o)), Ee.css("opacity", Ze("dragOpacity"));
        ...
        B(n.addClass("fc-agenda")), Le = new ue(function(e, n) {
            ...
            for (var s = we.offset().top, l = be.offset().top, c = l + be.outerHeight(), u = 0; Oe * ze > u; u++)
                e.push([r(s + We * u), r(s + We * (u + 1))])
    ...
    function te() {
        ...
        function a(e) {
            ...
            for (r = 0; v > r; r++)
                for (n = Y(0, r), u(n, h), a = ee(o(e, p, n, u(d(n), g - h))), ne(a), s = 0; s < a.length; s++)
                    for (l = a[s], c = 0; c < l.length; c++)
                        f = l[c], f.col = r, f.level = s, m.push(f);
            return m
        }
        function o(t, e, n, r) {
            var a, o, i, s, l, c, u, f, v = [], h = t.length;
            for (a = 0; h > a; a++)
                o = t[a], i = o.start, s = e[a], s > n && r > i && (n > i ? (l = d(n), u = !1) : (l = i, u = !0), s > r ? (c = d(r), f = !1) : (c = s, f = !0), v.push({event: o, start: l, end: c, isStart: u, isEnd: f, msLength: c - l}));
            return v.sort(B)
        }
        function i(t) {
        ...
        function s(n, r) {
            ...
            for (k = (S = y("isRTL"))? - 1:1, a = 0; H > a; a++)
                o = n[a], i = o.event, s = A(o.start, o.start), l = A(o.start, o.end), u = o.col, d = o.level, v = o.forward || 0, h = L(u), g = _(u) - h, g = Math.min(g - 6, .95 * g), p = d ? g / (d + v + 1) : v ? 2 * (g / (v + 1) - 6) : g, m = h + g / (d + v + 1) * d * k + (S ? g - p : 0), o.top = s, o.left = m, o.outerWidth = p, o.outerHeight = l - s, N += c(i, o);
            for (z[0].innerHTML = N, D = z.children(), a = 0; H > a; a++)
                o = n[a], i = o.event, w = t(D[a]), C = b("eventRender", i, i, w), C === !1 ? w.remove() : (C && C !== !0 && (w.remove(), w = t(C).css({position: "absolute", top: o.top, left: o.left}).appendTo(z)), o.element = w, i._id === r ? f(i, w, o) : w[0]._fci = a, U(i, w));
            for (T(z, n, f), a = 0; H > a; a++)
                o = n[a], (w = o.element) && (o.vsides = R(w, !0), o.hsides = x(w, !0), M = w.find(".fc-event-title"), M.length && (o.contentTop = M[0].offsetTop));
            for (a = 0; H > a; a++)
                o = n[a], (w = o.element) && (w[0].style.width = Math.max(0, o.outerWidth - o.hsides) + "px", E = Math.max(0, o.outerHeight - o.vsides), w[0].style.height = E + "px", i = o.event, o.contentTop !== e && E - o.contentTop < 10 && (w.find("div.fc-event-time").text(ie(i.start, y("timeFormat")) + " - " + i.title), w.find("div.fc-event-title").remove()), b("eventAfterRender", i, i, w))
        }
        function c(t, e) {
        ...
        function v(t, e, n) {
            ...
            e.draggable({opacity: y("dragOpacity", "month"), revertDuration: y("dragRevertDuration"), start: function(n, p) {
                    ...
                    if (u.stop(), te(), b("eventDragStop", e, t, n, a), o)
                        r(), e.css("filter", ""), Z(t, e);
                    else {
                        var s = 0;
        ...
        function g(t, e, n) {
            ...
            e.draggable({scroll: !1, grid: [S, x], axis: 1 == E ? "y" : !1, opacity: y("dragOpacity"), revertDuration: y("dragRevertDuration"), start: function(n, r) {
    ...
    function ne(t) {
        ...
        for (e = t.length - 1; e > 0; e--)
            for (a = t[e], n = 0; n < a.length; n++)
                for (o = a[n], r = 0; r < t[e - 1].length; r++)
                    i = t[e - 1][r], re(o, i) && (i.forward = Math.max(i.forward || 0, (o.forward || 0) + 1))
    }
    function re(t, e) {
    ...
    function ae(n, r, a) {
        ...
        function T(t, n, r, a) {
            ...
            for (var o, i = t.length, s = 0; i > s; s++)
                o = t[s], a !== e && (o.allDay = a), u(l(o.start, n, !0), r), o.end && (o.end = u(l(o.end, n, !0), r)), j(o, Z)
        }
        function E(t, e, n) {
            n = n || 0;
            for (var r, a = t.length, o = 0; a > o; o++)
                r = t[o], r.end = u(l(g(r), e, !0), n), j(r, Z)
        }
        function S(t) {
        ...
        function k(t, e, n) {
            for (e = e || 1; Q[(t.getDay() + (n?e:0) + 7) % 7]; )
                l(t, e)
        }
        function H() {
        ...
        !function() {
            ...
            for (var e = 0, n = 0; 7 > e; e++)
                K[e] = n, Q[e] = -1 != t.inArray(e, $), Q[e] || (te[n] = e, n++);
            if (G = n, !G)
    ...
    function oe() {
        ...
        function o(t) {
            for (var e = t.start, n = C(t), r = ee(e, n), a = 0; a < r.length; a++)
                r[a].event = t;
            return r
        }
        function i(t) {
        ...
        function v(t) {
            for (var e = Y(), n = P(), r = [], a = g(t), o = 0; e > o; o++) {
                ...
                for (var c = 0; c < i.length; c++) {
                    ...
                    for (var l = u.leftCol; l <= u.rightCol; l++)
        ...
        function p(t) {
            for (var e = [], n = m(t), r = 0; r < n.length; r++)
                e.push.apply(e, n[r]);
            return e
        }
        function m(t) {
    ...
    var De = ["sun", "mon", "tue", "wed", "thu", "fri", "sat"], we = 864e5, Ce = 36e5, Me = 6e4, Te = {s: function(t) {
            return t.getSeconds()
        }, ss: function(t) {
    ...
    pe.dateFormatters = Te, pe.applyAll = I, me.month = J, me.basicWeek = V, me.basicDay = U, n({weekMode: "fixed"}), me.agendaWeek = $, me.agendaDay = Q, n({allDaySlot: !0, allDayText: "all-day", firstHour: 6, slotMinutes: 30, defaultEventMinutes: 120, axisFormat: "h(:mm)tt", timeFormat: {agenda: "h:mm{ - h:mm}"}, dragOpacity: {agenda: .5}, minTime: 0, maxTime: 24})
}(jQuery);