...
$.fn.elfindercontextmenu = function(fm) {
	...
	return this.each(function() {
		var menu = $(this).addClass('ui-helper-reset ui-widget ui-state-default ui-corner-all elfinder-contextmenu flipInY animated elfinder-contextmenu-'+fm.direction)
				.hide()
				.appendTo('body')
...
$.fn.elfindersortbutton = function(cmd) {
	...
	return this.each(function() {
		var fm       = cmd.fm,
			...
			menu = $('<div class="ui-widget ui-widget-content elfinder-button-menu flipInY animated ui-corner-all"/>')
				.hide()
				.appendTo(button)
				.zIndex(12+button.zIndex())
				.delegate('.'+item, 'hover', function() { $(this).toggleClass(hover) })
